...
const Chatbot = () => {
    ...
    return (
        <div className="w-full h-full rounded-xl overflow-hidden">
            <div className="flex flex-col h-full dark:bg-gray-800 border dark:border-gray-600 rounded-xl shadow-md overflow-hidden">
                {/* Header */}
                <div className="flex items-center justify-center bg-blue-500 gap-2 p-3 border-b dark:border-gray-600">
                    <h2 className="sm:text-xl font-semibold text-center sm:mb-4 sm:mt-mt-0 mt-10 flex justify-center items-center gap-2">
                        <Spa fontSize="large" className="animate-bounce" />
                        Chatbot Spa Massage Trị liệu
                    </h2>
                </div>
                ...
                {/* Input */}
                <div className=" relative flex items-center gap-2 sm:mt-4 mb-7">
                    <textarea
                        ref={textareaRef}
                        value={input}
                    ...
                    {showSuggestions && suggestions.length > 0 && (
                        <div className="absolute bottom-full left-0 max-h-[120px] overflow-y-auto rounded-2xl bg-white/80 border border-gray-300 shadow-md mt-1 w-[50%] mb-3 dark:bg-gray-800 dark:border-gray-700">
